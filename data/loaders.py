...
def get_cifar_loader(root='D:\作业\神经网络与深度学习\PJ2\codes\VGG_BatchNorm\data\cifar-10-batches-py', batch_size=128, train=True, shuffle=True, num_workers=4, n_items=-1):
